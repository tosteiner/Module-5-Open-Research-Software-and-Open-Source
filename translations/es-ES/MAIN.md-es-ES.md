...
Prácticamente todos los flujos de trabajo de investigación científica moderna se basan en una gama de herramientas de software, ya sea que operen en diferentes conjuntos de datos con diferentes parámetros y se apliquen de manera iterativa de varias maneras (ciencia de datos), o que operen en diferentes entradas y utilicen modelos y métodos para predecir algún estado de salida ( Ciencia computacional). El Software de Código Abierto (SCA) es un software de computadora en el que el código fuente completo está disponible bajo una licencia específica que permite a otros usuarios acceder, ver, modificar y redistribuir ese código para cualquier propósito. Debido a que SCA requiere una licencia de este tipo, por lo general se mantiene de forma gratuita por defecto. Esta licencia explícita es también lo que diferencia a SCA del software libre. Reutilizar SCA para análisis, simulación y visualización para investigación suele ser también más fácil y más flexible en comparación con el software de propiedad. A menudo, lo conozcamos o no, ya estamos usando SCA como parte de nuestros propios flujos de trabajo de investigación.

SCA encaja en el esquema más amplio de Ciencia Abierta, ya que ayuda a hacer que el entorno de investigación completo, incluido el software que produjo los resultados de la investigación, sea totalmente accesible y reutilizable. Como tal, constituye un componente necesario para las mejores prácticas ([Jiménez et al., 2018](https://github.com/OpenScienceMOOC/Module-5-Open-Research-Software-and-Open-Source/blob/master/Reading%20Material_Open%20Source%20and%20Open%20Research%20Software/Jim%C3%A9nez%20et%20al.%2C%202018.pdf)) y la repetibilidad y reproducibilidad de la investigación (tanto personalmente como por otros), junto con otros componentes, como el intercambio de datos ([Stodden, 2010](https://github.com/OpenScienceMOOC/Module-5-Open-Research-Software-and-Open-Source/blob/master/Reading%20Material_Open%20Source%20and%20Open%20Research%20Software/Stodden%2C%202010.pdf)).

En algunos casos, el intercambio del código puede incluso ser condicional para la aceptación de manuscritos de investigación asociados ([Shamir et al., 2013](https://github.com/OpenScienceMOOC/Module-5-Open-Research-Software-and-Open-Source/blob/master/Reading%20Material_Open%20Source%20and%20Open%20Research%20Software/Shamir%20et%20al.%2C%202013.pdf)). Esto también es percibido generalmente para aumentar el impacto de la investigación ([Vandwalle, 2012](https://github.com/OpenScienceMOOC/Module-5-Open-Research-Software-and-Open-Source/blob/master/Reading%20Material_Open%20Source%20and%20Open%20Research%20Software/Vandewalle%2C%202012.pdf)).

Algunas de las ventajas comunes para los desarrolladores incluyen:

- Mayor fidelidad y empoderamiento del desarrollador;

- Costos más bajos de servicios y marketing;
...
Como tal, las principales ventajas para los investigadores (usuarios) incluyen **costos más bajos**, **transparencia incrementada**, **mayor seguridad y estabilidad**, **no hay 'dependencia' del proveedor con mayor control del usuario** y **mayor calidad en general**. Además, compartir SCA permite a los investigadores recibir mérito por sus esfuerzos, por ejemplo a través de la cita de software directa [(Smith et al., 2016)](https://github.com/OpenScienceMOOC/Module-5-Open-Research-Software-and-Open-Source/blob/master/Reading%20Material_Open%20Source%20and%20Open%20Research%20Software/Smith%20et%20al.%2C%202016.pdf).

Los SCA más usados incluyen el navegador</a> Internet Mozilla Firefox </a> y el [LibreOffice](https://www.libreoffice.org/) completo. LibreOffice es similar al popular Microsoft Office, que incluye un procesador de textos, administrador de hojas de cálculo y software de presentación de diapositivas, pero es completamente gratuito y de código abierto.</p> 

Algunos consideran que el movimiento SCA representa una tendencia contraria al neoliberalismo y la privatización, a través del desafío de las regulaciones y normas en la construcción y reutilización de la información, y una transformación potencial del capitalismo moderno al hacer que el software esté disponible abundantemente con mínimo esfuerzo. Ver [El movimiento del software libre / de código abierto: ¿resistencia o cambio?](https://doi.org/10.15448/1984-7289.2009.1.5569) por Panayiota Georgopoulou para más información sobre este tema.
